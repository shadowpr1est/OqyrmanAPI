        ...
        "/ai/books/{bookId}/explain": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Действие и выделенный текст",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ai.explainSelectionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ai/books/{bookId}/seed-conversation": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Действие, выделенный текст, ответ ИИ",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ai.seedConversationRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/ai.seedConversationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/ai.conversationListItem"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/ai.createConversationResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/ai.sendMessageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.resendResetCodeRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "ai.explainSelectionRequest": {
            ...
            "properties": {
                ...
                "target_lang": {
                    "description": "TargetLang используется только для action=translate. Допустимо ru|en|kk.\nПусто = ru (по умолчанию).",
                    "type": "string",
                    "enum": [
                        "ru",
                        "en",
        ...
        "reservation.reservationViewResponse": {
            ...
            "properties": {
                ...
                "user": {
                    "description": "User присутствует только в staff/admin контексте — при просмотре чужих броней.",
                    "allOf": [
                        {
